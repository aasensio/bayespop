...
! Prior for velocity
		read(12) priorVelocity%typ
		select case (priorVelocity%typ)
			case(0)
				read(12) priorVelocity%lower, priorVelocity%upper
				read(12) priorVelocity%mu
			case(1)
				read(12) priorVelocity%lower, priorVelocity%upper
				read(12) priorVelocity%mu, priorVelocity%sigma
		end select
		
! Prior for velocity
		read(12) priorDispersion%typ
		select case (priorDispersion%typ)
			case(0)
				read(12) priorDispersion%lower, priorDispersion%upper
				read(12) priorDispersion%mu
			case(1)
				read(12) priorDispersion%lower, priorDispersion%upper
				read(12) priorDispersion%mu, priorDispersion%sigma
		end select
